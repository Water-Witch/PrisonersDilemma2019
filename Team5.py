...
Our_team_name = 'Null'
team_strategy = 'So if they collude, then we shall collude. If they betray, we shall also betray. However if they have a repeated history of colluding we shall betray.'
...
def move(my_history, their_history, my_score, their_score):
    ...
    if my_history == 'c' and their_history == 'b':
      ...
      return 'b'
    elif my_history == 'b' and their_history == 'c':
      return 'c'
